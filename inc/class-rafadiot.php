...
if (!class_exists('Rafadiot')) {
    ...
    class Rafadiot extends TimberSite
    {
        ...
        public function __construct()
        {
             ...
             * Theme load...
             */
            // add_action('init', array($this, 'raf_theme_load'));
            /**
             * After setup theme...
             */
            add_action('after_setup_theme', array($this, 'raf_theme_setup'));
            /**
             * Enqueue styles...
             */
            add_action('wp_enqueue_scripts', array($this, 'raf_load_styles'));
            /**
             * Enqueue scripts...
             */
            add_action('wp_enqueue_scripts', array($this, 'raf_load_scripts'));
            /**
             * Modify widget...
             */
            add_action('widgets_init', array($this, 'raf_modify_default_widgets'), 11);
            /**
             * Remove admin bar...
             */
            add_action('wp_before_admin_bar_render', array($this, 'raf_wp_admin_bar_remove'));
            /**
             * Add logo login...
             */
            add_action('login_head', array($this, 'raf_custom_login_logo'));
            /**
             * Custom template redirect...
             */
            add_action('template_redirect', array($this, 'raf_template_redirect'));
            /**
             * --------------------------------------------------------------------------
             * End hook action...
             * --------------------------------------------------------------------------
             ...
             */
            add_filter('login_headerurl', array($this, 'raf_custom_login_logo_url'));
            /**
             * Change login logo title...
             */
            add_filter('login_headertitle', array($this, 'raf_custom_login_logo_title'));
            /**
             * Change footer text in back_office...
             */
            add_filter('admin_footer_text', array($this, 'raf_change_footer_text'));
            /**
             * Remove wp help bar...
             */
            add_filter('contextual_help', array($this, 'raf_remove_help_bar'), 999, 3);
            /**
             * Remove version styles...
             */
            add_filter('style_loader_src', array($this, 'raf_remove_wp_ver_css_js'), 15, 1);
            /**
             * Remove version scripts...
             */
            add_filter('script_loader_src', array($this, 'raf_remove_wp_ver_css_js'), 15, 1);
            /**
             * Add slug class...
             */
            // add_filter('body_class', array($this, 'raf_add_slug_to_body_class'));
            /**
             * Add upload file type...
             */
            add_filter('upload_mimes', array($this, 'raf_mime_types'), 1, 1);
            /**
             * Add Timber context...
             */
            add_filter('timber_context', array($this, 'raf_add_to_context'));
            /**
             * Add twig functions...
             */
            add_filter('get_twig', array($this, 'raf_add_to_twig'));
            /**
             * Rewrite url...
             */
            add_filter('wpseo_json_ld_search_url', array($this, 'raf_rewrite'));
            /**
             * --------------------------------------------------------------------------
             * End hook filter...
             * --------------------------------------------------------------------------
            ...
            if (!current_user_can('manage_options')) {
                 ...
                 * Modify admin menu...
                 */
                add_action('admin_menu', array($this, 'raf_modify_menus'));
                /**
                 * Modify dashboard block...
                 */
                add_action('wp_dashboard_setup', array($this, 'raf_remove_dashboard_widgets'));
                /**
                 * Disable admin bar...
                 */
             ...
             * Ajax...
             */
            // add_action('wp_ajax_raf_example', array($this, 'raf_example'));
            // add_action('wp_ajax_nopriv_raf_example', array($this, 'raf_example'));
        ...
        {
            if (!is_admin()) {
                wp_enqueue_style('main', RAF_URL . '/assets/css/app.min.css', array(), false, 'all');
            }
        }
        ...
        public function raf_load_scripts()
        {
            if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
                ...
                wp_enqueue_script('main', RAF_URL . '/assets/js/app.min.js', array('jquery'), false, true);
            }
            /**
             * Comment reply...
             */
             ...
             * Load ajax...
             */
            wp_localize_script('jquery', 'raf_ajax', array('ajax_url' => admin_url('admin-ajax.php')));
            /**
        ...
        public function raf_add_to_context($context)
        {
            ...
            if (has_nav_menu('header-menu')) {
                $context['header_menu'] = new Timber\Menu('header-menu', ['depth' => self::DEPTH]);
            }
            /**
             * Footer menu...
             */
            if (has_nav_menu('footer-menu')) {
                $context['footer_menu'] = new Timber\Menu('footer-menu', ['depth' => self::DEPTH]);
            }
            /**
             * Options data...
             */
